...
export type Page = 'dashboard' | 'sales' | 'stock-alerts' | 'turnover' | 'reports' | 'daily-report' | 'daily-stock' | 'stock-comparison' | 'store-types' | 'expenses' | 'pnl' | 'finance-settings' | 'banka' | 'cari';
